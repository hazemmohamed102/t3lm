...
<div class="col-lg-4 col-md-4 col-sm-4">
        <div class="latest_post">
          <h2><span>اخبار شائعة</span></h2>
          <div class="latest_post_container" style="height:500p; ">
          ...
          <div class="latest_post">
            ...
            <div class="tab-content">
              <div role="tabpanel" class="tab-pane active" id="category">
                <ul>
                <li class="cat-item">  <a href="all-posts.php">الجميع</a>  </li>
                <!-- adding category----------------------------------------------------------------- -->
                    <?php 
  ...
  <footer id="footer">
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
          ...
          <?php 
            ...
            <h2>التواصل</h2>
            <p>تواصل معنا في اي وقت.. نحن دائما في الخدمة</p>
            <address>
          
              <P> Address : <?php echo $address; ?></P>
              <P>  Phone: <a  style="color:rgb(218,218,218);" href="tel:<?php echo $phn ?>"> <?php echo $phn; ?> </a></P>
              <p>whatsapp : <a style="color:rgb(218,218,218);" href="fax:<?php echo $fax; ?>"> <?php echo $fax; ?> </a> </p>
    ...
    <div class="footer_bottom">
      <p class="copyright">جميع الحقوق محفوظة &copy; <?php echo date("Y" , strtotime("now") ); ?> <a href="./index.php">t3lm</a></p>
      <p class="developer" style="color:white;">Developed By Hazem Mohamed</p>
      <!-- Wpfreeware -->
    </div>
  </footer>
</div>
