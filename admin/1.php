              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h4 class="font-weight-normal mb-3">اجمالي التصنيفات <i class="mdi mdi-chart-line mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5"><?php echo mysqli_num_rows($result); ?></h2>
                    <h6 class="card-text"><a href="manage-category.php"><b>عرض جميع التصنيفات</b></a></h6>
                  </div>
                </div>
              </div>
              <div class="col-md-4 stretch-card grid-margin">
