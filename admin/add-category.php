...
<?php 
    ...
    if( $_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(empty($_REQUEST["cat_name"])){
            $category_error = "<p style='color:red'> * !! اسم التصنيف مطلوب</p>";
        }else {
        ...
        if( !empty($category) ){
            ...
            if( mysqli_num_rows($result) > 0 ){
                $category_error =  "<p style='color:red'>*التصنيف موجود بالفعل </p>";
            }else{
                ...
                if($add){
                    ...
                    $(document).ready( function(){
                        ...
                        $('#linkBtn').text('عرض جميع التصنيفات');
                        $('#addMsg').text('!تمت إضافة التصنيف بنجاح');
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5 shadow">                       
                                    <h4 class="text-center pb-3">إضافة تصنيف المنشورات</h4>
