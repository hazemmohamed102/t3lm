...
<?php
    ...
    if( $_SERVER["REQUEST_METHOD"] == "POST" ){
        ...
        if( empty($_FILES["thumbnail"]["name"])){
           $thumbnail_err = "<p style='color:red'> * صورة المنشور مطلوبة </p>";
        }else{
          ...
          $location = "upload/thumbnail/".$new_file_name;  
            ...
            $thumbnail_err = "<p style='color:red'> * فقط JPG , JPEG و PNG يسمح بتحميلهم </p>";
            $thumbnail_name ="";
          }
        }
        ...
        if($result_add_desc){
            ...
            $(document).ready( function(){
                ...
                $('#linkBtn').text('إضافة وصف المنشور');
                $('#addMsg').text('!تمت اضافة رأس المنشور بنجاح');
                $('#closeBtn').text('أضف المزيد');
            })
         </script>
         ";
        }
    ...
    <div id="form" class="pt-5 form-input-content">
        <div class="card login-form mb-0">
            <div class="card-body pt-3 shadow">
                <h4 class="text-center">إضافة وصف المنشور </h4>
                <form method="POST" enctype="multipart/form-data" action=" <?php htmlspecialchars($_SERVER['PHP_SELF']) ?>"> 
                <div class="form-group">
                        <label >أختر تصنيف المنشور: </label>
                        <select name="p_category" class="form-control" >
                            <option value="">رجاء اختر التصنيف: </option>
                            <?php    
                    ...
                    <div class="form-group">
                        <label> أضف وصف قصير للمنشور: </label>
                        <textarea name="editor" id="editor"  ><?php echo $editor; ?></textarea>
                        <?php echo $editor_err; ?>
                    </div>
                    <div class="form-group">
                        <label> أضف صورة للمنشور: </label>
